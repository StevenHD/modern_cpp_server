...
std::string HttpRequest::getMethod() const
{
    ...
    if (method_ == Get) res = "GET";
    else if (method_ == Post) res = "POST";
    else if (method_ == Head) res = "HEAD";
    else if (method_ == Put) res = "Put";
    else if (method_ == Delete) res = "DELETE";
...
std::string HttpRequest::getHeader(const std::string& field) const
{
    ...
    if (itr != headers_.end()) res = itr -> second;
    return res;
}
